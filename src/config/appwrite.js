...
export const ContactCollection = process.env.NEXT_PUBLIC_CONTACT_ID;
// export const FeedbackCollection = process.env.NEXT_PUBLIC_FEEDBACK_ID;
...
export const HackOnTeams = process.env.NEXT_PUBLIC_HACK_ON_TEAMS;
export const HackOnMembers = process.env.NEXT_PUBLIC_HACK_ON_MEMBERS;
export const CoupansCollection = process.env.NEXT_PUBLIC_COUPANS;
export const HackOnTimerCollection = process.env.NEXT_PUBLIC_HACK_ON_TIMER;
export const KananSurveyCollection = process.env.NEXT_PUBLIC_KANAN_SURVEY;
